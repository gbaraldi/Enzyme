...
setfield!(typeof(runtime_newstruct_augfwd).name.mt, :max_args, Int64(512), :monotonic)
setfield!(typeof(runtime_newstruct_rev).name.mt, :max_args, Int64(512), :monotonic)
setfield!(typeof(runtime_tuple_augfwd).name.mt, :max_args, Int64(512), :monotonic)
setfield!(typeof(runtime_tuple_rev).name.mt, :max_args, Int64(512), :monotonic)
